  ...
  return (
    <div className={cn("relative", className)}>
      ...
      <button
        ...
        className="absolute end-3 top-1/2 -translate-y-1/2 text-slate-500 hover:text-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 rounded-md"
      >
