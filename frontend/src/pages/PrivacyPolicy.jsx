        ...
        <div className="prose prose-slate max-w-none space-y-6 text-slate-700 leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              automation are retained only as needed to operate enabled automations, show status, and support safe
              retries. Access tokens are removed when you disconnect Instagram or delete your account. Operational
              records tied to your account are deleted or anonymized when a verified account deletion request is completed.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              To request deletion of all your personal data and Instagram data stored by mychat, use the
              <Link to="/data-deletion" className="text-blue-600 hover:underline"> Data Deletion page</Link> or send an email to
          ...
          <section>
            ...
            <p>
              Access tokens are stored only on the backend and are not returned to the frontend. All traffic is served
              over HTTPS in production. Passwords are hashed using industry-standard algorithms (bcrypt). Access to
              production data is restricted to authorized personnel.
