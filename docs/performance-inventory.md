...
| `/app/system-health` | REMOVED (frontend removed, backend `/api/` health remains) | N/A | N/A | N/A | N/A | N/A | Frontend removed in 2.13B, backend health preserved |
| `/app/broadcasting` | REMOVED (frontend removed, backend deprecated) | N/A | N/A | N/A | N/A | N/A | Frontend removed in 2.13B |
